        ...
        <div class="row px-2 h-96"  data-aos="fade-in" data-aos-delay="1000" data-aos-duration="1000">
            ...
            <?php $__currentLoopData = $testimoni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div data-aos="fade-in" data-aos-delay="1000" data-aos-duration="1000">
                    <img src="<?php echo e(asset('storage/'.$t->photo)); ?>" alt="Avatar Testimoni" width="95px" height="95px" class="m-auto rounded-circle" data-aos="fade-in" data-aos-delay="700" data-aos-duration="1000">
                    <p class="text-yellow testimoni-content mt-2 text-sm" data-aos="fade-in" data-aos-delay="850" data-aos-duration="1000"> <?php echo Str::words($t->description, 20, ' ...'); ?></p>
                    <p class="text-yellow mt-2 text-sm testimoni-name" data-aos="fade-in" data-aos-delay="1000" data-aos-duration="1000"><?php echo e($t->name); ?></p>
                </div>
...
<?php echo $__env->make('layouts.front-website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\tekenens_project\resources\views/pages/main.blade.php ENDPATH**/ ?>