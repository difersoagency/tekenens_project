    ...
    <footer class="footer-web px-2 py-3 px-md-2 py-md-3 px-lg-5 py-lg-5">
        <div class="row container justify-content-between mx-md-auto gap-5 gap-md-0">
            <div class="col-12 col-md-3">
                <img src="../../assets/images/logo-footer.png" alt="Logo Tekenens" width="80%" height="auto"  data-aos="fade-up" data-aos-delay="1000" data-aos-duration="800">
            </div>
...
<?php /**PATH C:\xampp\htdocs\tekenens_project\resources\views/layouts/front-website/footer.blade.php ENDPATH**/ ?>