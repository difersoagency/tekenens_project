    ...
    <section class="portfolio-archive my-5">
        ...
        <div class="category-text mt-4 px-5 row mx-auto">
            ...
            <div class="col-6 col-md-2 text-center font-semibold">
                <a type="button" data-id="<?php echo e($c->id); ?>" id="cat<?php echo e($c->id); ?>" class="category_filter"><?php echo e(ucfirst($c->name)); ?> </a>
            </div>
...
<?php echo $__env->make('layouts.front-website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\clone wisnu\tekenens_project\resources\views/pages/portfolio.blade.php ENDPATH**/ ?>