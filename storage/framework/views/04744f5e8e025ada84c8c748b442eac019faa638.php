          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 footer-copyright">
                <p class="mb-0">Copyright <?php echo e(date('Y')); ?>-<?php echo e(date('y', strtotime('+1 year'))); ?> © Diverso All rights reserved.</p>
              </div>
...
<?php /**PATH C:\xampp\htdocs\tekenens_project\resources\views/layouts/admin/master.blade.php ENDPATH**/ ?>