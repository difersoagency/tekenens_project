				...
				<div class="card">
                    ...
                    <?php echo e(method_field('PUT')); ?>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-6 col-md-8 col-sm-12">
                        	    <input class="form-control" type="file" id="thumbnail" name="thumbnail" placeholder="Choose JPG/PNG File" accept="image/png, image/jpeg, image/jpg" value="<?php echo e($j->photo); ?>"/>
                        ...
                        <div class="mb-3">
                        	...
                        	<textarea class="summernote" id="editor1" name="content"><?php echo e($j->description); ?></textarea>
