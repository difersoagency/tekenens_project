                        ...
                        <div class="mb-3">
                            ...
                            <div class="table-responsive">
                                <table class="table align-center" id="pictable">
                                    ...
                                    <tbody>
                                        @foreach($p->DetailPortofolio as $i)
                                        <tr>
                                            <td>{{$loop->iteration}}</td>
                                            <td> <img id="pic_preview" style="width:50%; height: auto" class="mt-1" src="{{asset('storage/images/portofolio')}}/{{$p->id}}/{{$i->media}}"/><input type="text" id="photo" name="photo[]" hidden="true" value="{{$i->media}}"/></td>
                                            <td>{{strtoupper($i->status)}}<input type="text" id="image_status" name="image_status[]" hidden="true" value="{{$i->status}}"/></td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <img id="photoPreview" style="width:50%; height: auto" class="mt-1"/>
    ...
    <script>
        ...
        $(function(){
            ...
            $(document).on('shown.bs.modal', '#addpicmodal', function () {
                $('#add_picture').val("");
                $('#photoPreview').attr('src', "");
                $('input[name="add_status"]').prop('checked', false);
            })
