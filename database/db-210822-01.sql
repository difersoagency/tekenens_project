...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2022 at 11:05 AM
...
INSERT INTO `article` (`id`, `user_id`, `slug`, `title`, `content`, `og_image`, `meta_desc`, `status`) VALUES
(1, 1, 'review-arrietty-1', 'Arrietty', '<p>WE WOULD LOVE TO SEE <em><strong>ARRIETTY</strong></em> MANY TIMES!</p>', '49fa9fedae57f72c5e99313e5e6a0b00.jpg', 'We love Arrietty so much', '1');
...
INSERT INTO `detail_page_desc` (`id`, `title`, `page_id`, `media`, `description`) VALUES
(5, 'About', 5, NULL, '<p>Tekenens made your best design to be <strong>incredible. <em>Go get yours</em></strong>!</p>');
...
CREATE TABLE `detail_portofolio` (
  ...
  `title` text NOT NULL,
  `media` text DEFAULT NULL,
  `status` enum('draft','sketch','final') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `detail_portofolio` (`id`, `portofolio_id`, `title`, `media`, `status`) VALUES
(6, 30, 'shutterstock-pic0', '629ffe379f17c_nicolette-meade-RL3F99l0XYE-unsplash.jpg', 'draft'),
(8, 30, 'shutterstock-pic0', '62a001086d95f_kadir-celep-A8aJwJ49rVM-unsplash.jpg', 'draft'),
(11, 31, 'Testing-the-Portofolio0', '62a005fcb9c75_5076524.jpg', 'draft'),
(12, 31, 'Testing-the-Portofolio1', '62a0060b29083_3222.jpg', 'draft'),
(13, 32, 'test0', '6301d38c08433_027886600_1426159285-arrietty.jpg', 'draft'),
(15, 32, 'test1', '6301e8a7cf514_recruitment.png', 'sketch');
...
(1, 'e3b1c57412cbecac48cb1fc5faaf44d4.png', 'administrasi-kantor', '<p>Dibutuhkan <strong>Administrasi Kantor</strong> dengan ketentuan sebagai berikut:</p>\r\n\r\n<ol>\r\n	<li>Wanita max 25 tahun</li>\r\n	<li>Minimal S1 dibidang yang sama</li>\r\n	<li>Good Attitude, Good Performance</li>\r\n</ol>\r\n\r\n<p>Lamaran bisa diisi dibawah ini paling lambat <em><strong>25 Juni 2022</strong></em></p>', 'maria-hrd@tekenens.com', 'Administrasi Kantor', '1');
...
(5, 'Tekenens made best Design', '5d206efbef79afe6dbd338804c0e70f9.jpg', 'About'),
(6, NULL, 'f6c0d41e98102cd5ecfc739d9ee4aed8.mp4', 'Home');
...
(32, 'tes', 'test', 'Tes', '2022-08-21 00:00:00', '0');
